...
const QUOTES = [
  ...
  // — дашборд-панч
  "Метрики придумали ради этого дашборда.",
  "Пока вы сверяете цифры — цифры сверяются со мной.",
  "Графики растут вверх. Как и счёт к тем, кто недосписал часы.",
  // — про градус (оставляем как есть, оно топ)
  "Можешь сбавить скорость работы, сбавить обороты. Но никогда, никогда не сбавляй градус.",
  // — пацанские, поагрессивнее (про зубы), но чисто
  "Не скаль зубы на мои дедлайны — пересчитаю.",
  "Показал зубы задаче — задача показала, где выход.",
  "Кусаешь больше, чем можешь прожевать? У меня челюсть крепче.",
  "Улыбаешься просрочке? Улыбка — единственное, что у тебя останется целым.",
  "Слабый ищет причину. Сильный — следующую задачу.",
  "Проблемы боятся не решений. Проблемы боятся меня.",
